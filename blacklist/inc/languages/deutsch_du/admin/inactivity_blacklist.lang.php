...
$l['setting_inactivity_blacklist_applicant_group'] = "Ausgeschlossene Bewerber-Gruppe";
$l['setting_inactivity_blacklist_applicant_group_desc'] = "Wähle die Benutzergruppe aus, die von der Inaktivitätsprüfung komplett ausgenommen werden soll (z.B. Bewerber).";
$l['setting_inactivity_blacklist_grace_period'] = "Löschung nach X Tagen.";
$l['setting_inactivity_blacklist_response_grace_period'] = "Reaktions-Gnadenfrist (Tage)";
$l['setting_inactivity_blacklist_response_grace_period_desc'] = "Wie viele Tage hat ein Charakter Zeit, auf einen neuen Post in seiner Szene zu antworten, bevor die Inaktivitätsprüfung für ihn wieder greift? (Empfehlung: 7)";
$l['setting_inactivity_blacklist_inactive_group'] = "Gruppe der inaktiven User";
$l['setting_inactivity_blacklist_inactive_group_desc'] = "In diese Gruppe werden inaktive User verschoben";
